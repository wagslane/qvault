...
it("GetMasterKeyFromCardQRSuccess", () => {
  const masterKey = GetMasterKeyFromCardQR(
    "Y6Z46buO2GYUDdSoab6j1A==",
    "16UjcYNBG9"
  );
  const randomMasterKey = GetNewMasterKey();
  expect(randomMasterKey.length).toEqual(masterKey.length);
...
it("GetMasterKeyFromCardQRFail", () => {
  const masterKeyBadMnemonic = GetMasterKeyFromCardQR(
    "Y6Z46buO2GYUDdSoab6j1==",
    "16UjcYNBG9"
  );
  const masterKeyBadPrivateCode = GetMasterKeyFromCardQR(
    "Y6Z46buO2GYUDdSoab6j1A==",
    "16UjcYNBG"
  );
  const randomMasterKey = GetNewMasterKey();
